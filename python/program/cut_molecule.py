...
##f='C:\Users\Hom\Desktop\ligand_ring6.pdb'
##f2='C:\Users\Hom\Desktop\ligand_ring2.pdb'
##a=Conect()
##a.read_conects_PDB(f2)
##hi=a.fragmentation()
##hey=a.count_fragment(hi)
##hey.sort(sortlen)
####b=Conect()
####b.read_conects_MOL2('C:\Users\Hom\Desktop\ligand_ring6.mol2')
####hi=b.fragmentation()
####hey=b.count_fragment(hi)
####hey.sort(sortlen)
##c=PDB()
##c.LoadPDB(f)
##c.heavy_atoms_Conects.fragmentation()
##c.savefragments_each()
